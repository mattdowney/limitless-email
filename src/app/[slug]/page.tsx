...
import LimitlessCTA from '@/components/blog/LimitlessCTA';
import { getPostBySlug, getAllPosts } from '@/lib/blog';
import { generateBlogPostMetadata, generateStructuredData } from '@/lib/seo';
import { insertCTAIntoContent } from '@/lib/content-insert';
...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  const shareUrl = `https://limitless.email/${slug}`;
  const htmlContent = await marked(post.content);
  const { beforeCTA, afterCTA, hasCTA } = insertCTAIntoContent(htmlContent);
